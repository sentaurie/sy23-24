Public Class Form4
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        UserControl12.PictureBox1.Image = UserControl12.ImageList1.Images(13)
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        UserControl12.PictureBox1.Image = UserControl12.ImageList1.Images(12)
    ...
    Private Sub Button3_Click(sender As Object, e As EventArgs) Handles Button3.Click
        UserControl12.PictureBox1.Image = UserControl12.ImageList1.Images(11)
        UserControl12.priceLabel.Text = 40.ToString("C2")
        UserControl12.descriptionTextBox.Text = "DDR4 3600 (PC4 28800), Timing 18-22-22-42, CAS Latency 18, Voltage 1.35V"
    End Sub
    Private Sub Button4_Click(sender As Object, e As EventArgs) Handles Button4.Click
        UserControl12.PictureBox1.Image = UserControl12.ImageList1.Images(10)
